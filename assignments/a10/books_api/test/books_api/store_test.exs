defmodule BooksApi.StoreTest do
  ...
  describe "books" do
    ...
    test "create_book/1 with valid data creates a book" do
      valid_attrs = %{description: "some description", title: "some title", isbn: "some isbn", price: 120.5, authors: ["option1", "option2"]}
    ...
    test "update_book/2 with valid data updates the book" do
      book = book_fixture()
      update_attrs = %{description: "some updated description", title: "some updated title", isbn: "some updated isbn", price: 456.7, authors: ["option1"]}
